...
import type { MominCoin, MominCoinInterface } from "../MominCoin";
...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract MOMINDividendTracker",
        name: "",
        type: "address",
      },
    ],
  ...
  },
  {
    inputs: [
      {
        internalType: "uint256",
        name: "_extraFeeOnSell",
        type: "uint256",
      },
    ],
    name: "setExtraFeeOnSell",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export class MominCoin__factory {
  static readonly abi = _abi;
  static createInterface(): MominCoinInterface {
    return new utils.Interface(_abi) as MominCoinInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MominCoin {
    return new Contract(address, _abi, signerOrProvider) as MominCoin;
  }
}
